...
<html>
	...
	<body style="background-color:Snow;">
		...
		<h1 style="margin:auto;text-align:center;color:Tomato;"><u>Welcome to the Task Planner</u></h1><br>

		<div id="taskForm" style="background-color:Cornsilk;">
        ...
        <div id="taskDeleteForm" style="background-color:Cornsilk;">
		...
		<div id="taskTableDiv" >
			<table id="taskTable" style="background-color:Cornsilk;">
				<thead>
					<th>Task ID</th>
					<th>Employee ID</th>
					<th>Employee Name</th>
